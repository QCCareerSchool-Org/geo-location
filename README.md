...
**@so-ric/colorspace** has numeric separators (`_`), logical OR assignment operators (`||=`), and `Object.hasOwn`. These aren't supported by Node 10.

Replace node_modules/@so-ric/colorspace/dist/index.cjs.js with:
